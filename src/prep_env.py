...
def create_folders():
    ...
    print(f"Created {new_folder} to hold processed files.\n")
    ...
    print(f"Created {split_files_folder} to hold successfully split files.\n")
    ...
    print(f"Created {manual_splitting_folder} to hold files that fail auto-splitting.\n")
